...
//...so we use the x and y functions above to generate a x,y for each data point (date and unemployment_rate)
...
d3.json("js/como_employment.json", function(error, data) {
